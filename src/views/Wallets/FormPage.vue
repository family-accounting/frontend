<template>
  <IonPage>
    ...
    <IonContent :fullscreen="true" :scroll-y="true" class="ion-padding">
      <form>
        <IonItem>
          <IonInput type="text" v-model="wallet.name" label-placement="floating" label="Name"></IonInput>
        </IonItem>
        <IonItem>
          <IonSelect label-placement="floating" label="Icon" v-model="wallet.icon">
            <IonSelectOption value="person">Person</IonSelectOption>
          </IonSelect>
        </IonItem>
        <IonItem>
          <IonSelect label-placement="floating" label="Color" v-model="wallet.color">
            <IonSelectOption value="primary">Primary</IonSelectOption>
          </IonSelect>
        </IonItem>
        <IonItem>
          <IonTextarea label-placement="floating" label="Description" v-model="wallet.description"></IonTextarea>
        </IonItem>
        <IonGrid>
          <IonRow>
            <IonCol>
